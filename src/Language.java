...
public class Language {
    public static void main(String[] args) {
        ...
        PolishCollector polishCollector = new PolishCollector("PolishText.txt", order);
        List<String> polishAlphabet = polishCollector.getAlphabet();
        System.out.println("Polish: " + polishAlphabet);

        SwedishCollector swedishCollector = new SwedishCollector("SwedishText.txt", order);
        List<String> swedishAlphabet = swedishCollector.getAlphabet();
        System.out.println("Swedish: " + swedishAlphabet);
        System.out.println();
